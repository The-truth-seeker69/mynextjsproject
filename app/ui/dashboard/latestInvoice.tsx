...
export default function LatestInvoice() {
    const customersData = [
        { custName: "nigga123", custEmail: "nigga23123@gmail.com", custInvAmount: "$" + 1000 },
        { custName: "nigga", custEmail: "nigga@gmail.com", custInvAmount: "$" + 1000 },
        { custName: "nigga1", custEmail: "nigga@gmail.com", custInvAmount: "$" + 1000 },
        { custName: "nigga2", custEmail: "nigga123@gmail.com", custInvAmount: "$" + 1000 },
        ...
        <div className="rounded-xl bg-gray-50 p-6 shadow-sm w-full  ">
            <div className=" p-2 bg-white rounded-lg shadow-md">
                {customersData.map((customer, index) => (
                    <div className="flex justify-between p-5  items-center border-b border-gray-300 last:border-b-0 ">
                        <div>
